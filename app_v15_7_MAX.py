...
if painel == "📘 Relatório Final":
    ...
    # FASE 1 — Tradução Canônica (Somente Leitura)
    # ============================================================
    try:
...
""".strip()
    ...
    # FASE 1 — Documentação (Sem uso operacional)
    # ============================================================
    try:
        ...
        # Prioridade: pacote operacional, se existir
        ...
        if listas_para_registro:
            ...
            for i, lst in enumerate(listas_para_registro[:20], start=1):
                linhas.append(f"L{i}: " + ", ".join(str(x) for x in lst))
