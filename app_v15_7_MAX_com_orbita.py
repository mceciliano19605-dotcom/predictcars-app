...
# ============================================================
# PredictCars V15.7 MAX — BUILD AUDITÁVEL v16h57EY — CT FORTE + CONVERSÃO DE FAMÍLIA + AJUSTE FINAL DE PRESSÃO + BANNER OK
# ============================================================

BUILD_TAG = "v16h57EY — CT FORTE + CONVERSÃO DE FAMÍLIA + AJUSTE FINAL DE PRESSÃO + BANNER OK"
BUILD_REAL_FILE = "app_v15_7_MAX_com_orbita_BUILD_AUDITAVEL_v16h57EY_CT_FORTE_CONVERSAO_FAMILIA_AJUSTE_FINAL_PRESSAO_BANNER_OK.py"
BUILD_CANONICAL_FILE = "app_v15_7_MAX_com_orbita.py"
BUILD_TIME = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
WATERMARK = "2026-03-02_01 (UNI50_60_AUDIT_FIX)"

# ⚠️ st.set_page_config precisa ser a PRIMEIRA chamada Streamlit
st.set_page_config(page_title="PredictCars V15.7 MAX — v16h57EY — BUILD AUDITÁVEL (CT forte + seleção de família combinatória)", page_icon="🚗", layout="wide")
    ...
    try:
        ...
        def pair_score(cand, base_now):
            ...
            for b in base_now:
                ...
                score += float(co_matrix.get(pair, 0)) * 0.161
    ...
    try:
        ...
        try:
            ...
            if cp_scores:
                ...
                # v16h57EY — INJECAO BORDA-PERTO REAL
                ...
                try:
                    ...
                    if inj_candidates:
                        # v16h57EY — injecao mais agressiva: até 3 candidatos subindo até a posição 7
        ...
        # v16h57EY — montagem final profunda para conversão
...
def _m5_leitura_regime_light(df_cut, universo_min, universo_max):
    ...
    try:
        ...
        w = min(120, max(30, int(len(df_cut) * 0.161)))
        dfw = df_cut.tail(w)
