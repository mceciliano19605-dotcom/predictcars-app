...
BUILD_TAG = "v16h57DN — CT MODE6 GENERATOR PRE-SANIDADE REAL HOOK + BANNER OK"
BUILD_REAL_FILE = "app_v15_7_MAX_com_orbita_BUILD_AUDITAVEL_v16h57DN_CT_REAL_GENERATOR_PRE_SANIDADE_HOOK_BANNER_OK.py"
BUILD_CANONICAL_FILE = "app_v15_7_MAX_com_orbita.py"
BUILD_TIME = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
WATERMARK = "2026-03-02_01 (UNI50_60_AUDIT_FIX)"

# ⚠️ st.set_page_config precisa ser a PRIMEIRA chamada Streamlit
st.set_page_config(page_title="PredictCars V15.7 MAX — v16h57DN — BUILD AUDITÁVEL (CT mode6 generator pre-sanidade real hook)", page_icon="🚗", layout="wide")
...
st.markdown(
    ...
    <div style="background-color:#111;
        ...
        EXECUTANDO AGORA (BUILD REAL): app_v15_7_MAX_com_orbita_BUILD_AUDITAVEL_v16h57DN_CT_REAL_GENERATOR_PRE_SANIDADE_HOOK_BANNER_OK.py
        </h2>
        <p style="color:white;margin:8px 0 0 0; font-size: 15px;">
        <b>Arquivo canônico no GitHub/Streamlit:</b> {BUILD_CANONICAL_FILE}<br>
        <b>BUILD:</b> v16h57DN — CT MODE6 GENERATOR PRE-SANIDADE REAL HOOK + BANNER OK<br>
...
st.sidebar.warning(
    f"EXECUTANDO AGORA (BUILD REAL): app_v15_7_MAX_com_orbita_BUILD_AUDITAVEL_v16h57DN_CT_REAL_GENERATOR_PRE_SANIDADE_HOOK_BANNER_OK.py
