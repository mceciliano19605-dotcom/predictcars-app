...
BUILD_TAG = "v16h57FX — FINAL CONVERSION NUDGE + ROTATION SLOT CONTROLLED + FAMILY LOCK PRESERVED + BANNER OK"
BUILD_REAL_FILE = "app_v15_7_MAX_com_orbita_BUILD_AUDITAVEL_v16h57FX_FINAL_CONVERSION_PUSH_STRUCTURE_PRESERVED_MICRO_PRIORITY_ADJUST_BANNER_OK.py"
BUILD_CANONICAL_FILE = "app_v15_7_MAX_com_orbita.py"
BUILD_TIME = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
WATERMARK = "2026-03-02_01 (UNI50_60_AUDIT_FIX)"

# ⚠️ st.set_page_config precisa ser a PRIMEIRA chamada Streamlit
st.set_page_config(page_title="PredictCars V15.7 MAX — v16h57FX — BUILD AUDITÁVEL (final conversion push)", page_icon="🚗", layout="wide")
...
def pc_v16_packet_final_mount_deep(listas_packet, ranking_vals=None, cp_scores=None, co_matrix=None, n_alvo=6, top_k=10):
    try:
        ...
        # v16h57FX — final conversion push + structure preserved + micro priority adjust
