...
BUILD_TAG = "v16h57ED — CT FORTE + BORDA DIRETA NO RANKING2 + BANNER OK"
BUILD_REAL_FILE = "app_v15_7_MAX_com_orbita_BUILD_AUDITAVEL_v16h57ED_CT_FORTE_BORDA_DIRETA_WEIGHT_BOOST_BANNER_OK.py"
        ...
        try:
            ...
            if cp_scores:
                ...
                ranking2 = sorted(
                    ...
                    key=lambda v: (
                        -(cp_scores.get(int(v), 0.0) * 1.15 + max(0.0, 1.0 - (_base_idx.get(int(v), 9999) / max(1, len(ranking2))))),
