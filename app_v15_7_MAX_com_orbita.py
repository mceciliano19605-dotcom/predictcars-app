...
# ============================================================
# PredictCars V15.7 MAX — BUILD AUDITÁVEL v16h57ES — CT FORTE + MICRO-AJUSTE FINAL DE FAMÍLIA + CONVERGÊNCIA CONTROLADA + BANNER OK
# ============================================================

BUILD_TAG = "v16h57ES — CT FORTE + MICRO-AJUSTE FINAL DE FAMÍLIA + CONVERGÊNCIA CONTROLADA + BANNER OK"
BUILD_REAL_FILE = "app_v15_7_MAX_com_orbita_BUILD_AUDITAVEL_v16h57ES_CT_FORTE_SELECAO_FAMILIA_COMBINATORIA_BANNER_OK.py"
BUILD_CANONICAL_FILE = "app_v15_7_MAX_com_orbita.py"
BUILD_TIME = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
WATERMARK = "2026-03-02_01 (UNI50_60_AUDIT_FIX)"

# ⚠️ st.set_page_config precisa ser a PRIMEIRA chamada Streamlit
st.set_page_config(page_title="PredictCars V15.7 MAX — v16h57ES — BUILD AUDITÁVEL (CT forte + seleção de família combinatória)", page_icon="🚗", layout="wide")
    ...
    try:
        ...
        def pair_score(cand, base_now):
            ...
            for b in base_now:
                ...
                score += float(co_matrix.get(pair, 0)) * 0.165
    ...
    try:
        ...
        try:
            ...
            if cp_scores:
                ...
                # v16h57EK — INJECAO BORDA-PERTO REAL
                ...
                try:
                    ...
                    if inj_candidates:
                        # v16h57EK — injecao mais agressiva: até 3 candidatos subindo até a posição 7
...
def _m5_leitura_regime_light(df_cut, universo_min, universo_max):
    ...
    try:
        ...
        w = min(120, max(30, int(len(df_cut) * 0.165)))
        dfw = df_cut.tail(w)
