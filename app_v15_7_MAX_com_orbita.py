...
BUILD_TAG = "v16h57INTERLISTA_REFERENCE_ORDER_FIX_OK"
BUILD_REAL_FILE = "app_v16h57INTERLISTA_REFERENCE_ORDER_FIX_OK.py"
BUILD_CANONICAL_FILE = "app_v15_7_MAX_com_orbita.py"
BUILD_TIME = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
WATERMARK = "BUILD: v16h57INTERLISTA_REFERENCE_ORDER_FIX_OK"
