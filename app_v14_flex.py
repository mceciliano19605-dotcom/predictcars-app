...
# ============================================================
# CONFIGURAÇÃO GERAL DO APP FLEX
# ============================================================

st.set_page_config(
    page_title="Predict Cars V14-FLEX",
    page_icon="🚗",
    layout="wide",
)
...
st.sidebar.title("🚗 Predict Cars V14-FLEX")
st.sidebar.markdown("Versão FLEX: número variável de passageiros + validação (QDS / Backtest / Monte Carlo).")
...
if painel == "📥 Histórico — Entrada":
    ...
    if df is not None and not df.empty:
        ...
        st.markdown(f"### ℹ️ Estrutura FLEX detectada")
...
# ============================================================
# PAINEL 5 — Testes de Confiabilidade (QDS / Backtest / Monte Carlo)
# ============================================================
